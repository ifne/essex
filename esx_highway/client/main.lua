...
function OpenArmoryMenu(station)
  ...
  if Config.EnableArmoryManagement then
    ...
    for i=1, #Config.highway.AuthorizedWeapons, 1 do
      local weapon = Config.highway.AuthorizedWeapons[i]
...
function OpenVehicleSpawnerMenu(station, partNum)
  ...
  if Config.EnableSocietyOwnedVehicles then
    ...
    ESX.TriggerServerCallback('esx_society:getVehiclesInGarage', function(garageVehicles)
      ...
      ESX.UI.Menu.Open(
        ...
        function(data, menu)
          ...
          TriggerServerEvent('esx_society:removeVehicleFromGarage', 'highway', vehicleProps)
        ...
        function(data, menu)
          ...
          CurrentActionData = {station = highway, partNum = partNum}
    ...
    for i=1, #Config.Highway.AuthorizedVehicles, 1 do
      local vehicle = Config.highway.AuthorizedVehicles[i]
...
AddEventHandler('esx_firejob:hasEnteredMarker', function(station, part, partNum)
  ...
  if part == 'HelicopterSpawner' then
    ...
    local helicopters = Config.highway.Helicopters
...
AddEventHandler('esx_firejob:hasEnteredEntityZone', function(entity)
  ...
  if PlayerData.job ~= nil and PlayerData.job.name == 'highway' and not IsPedInAnyVehicle(playerPed, false) then
...
Citizen.CreateThread(function()
  ...
  for k,v in pairs(Config.Highway) do
...
Citizen.CreateThread(function()
  while true do
    ...
    if PlayerData.job ~= nil and PlayerData.job.name == 'highway' then
      ...
      for k,v in pairs(Config.Highway) do
        ...
        if Config.EnablePlayerManagement and PlayerData.job ~= nil and PlayerData.job.name == 'highway' and PlayerData.job.grade_name == 'boss' then
...
Citizen.CreateThread(function()
  while true do
    ...
    if CurrentAction ~= nil then
      ...
      if IsControlPressed(0,  Keys['E']) and PlayerData.job ~= nil and PlayerData.job.name == 'highway' and (GetGameTimer() - GUI.Time) > 150 then
        ...
        if CurrentAction == 'delete_vehicle' then
          ...
          if Config.EnableSocietyOwnedVehicles then
            ...
            TriggerServerEvent('esx_society:putVehicleInGarage', 'highway', vehicleProps)

          else

            if
              GetEntityModel(vehicle) == GetHashKey('highway') 
            then
    ...
    if IsControlPressed(0,  Keys['F6']) and PlayerData.job ~= nil and PlayerData.job.name == 'highway' and not ESX.UI.Menu.IsOpen('default', GetCurrentResourceName(), 'fire_actions') and (GetGameTimer() - GUI.Time) > 150 then
      OpenFireActionsMenu()
      GUI.Time = GetGameTimer()
    end
...
function openFire()
  if PlayerData.job ~= nil and PlayerData.job.name == 'highway' and not ESX.UI.Menu.IsOpen('default', GetCurrentResourceName(), 'fire_actions') and (GetGameTimer() - GUI.Time) > 150 then
    OpenFireActionsMenu()
    GUI.Time = GetGameTimer()
  end
end
